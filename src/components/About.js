...
const About = () => {
    ...
    return (
        <div id="about" className="mt-5 pt-8">
            <div className=" mt-5 mb-5">
                <Title title="À propos de moi" icon={work} color="#1f2235"/>
            </div>
            <div className="flex mx-auto items-center">
                <div className="p-2 grid lg:grid-cols-5 gap-4 lg:gap-8 mx-auto">
                    <div className="p-4">
                    ...
                    <div className="p-4 border-l">
                        ...
                        <h3 className="mb-4 font-bold"><Public/> <a href="https://hammaali.ma/">www.hammaali.ma</a></h3>
                    </div>
                    <div className="p-4 border-l">
                        ...
                        {langages.map( skill => (
                            <div className="flex justify-between mt-4 mx-auto">
                                ...
                                <Rating
                                    ...
                                    value={skill.level}
                                    readOnly
                                    icon={<Circle className="text-dark-blue w-2"/>}
                                    emptyIcon={<CircleOutlined className="text-dark-blue w-2"/>}
                                />
                            </div>
                        ))}
                    </div>
                    <div className="p-4 border-l grid grid-cols-2 gap-2 w-fit">
